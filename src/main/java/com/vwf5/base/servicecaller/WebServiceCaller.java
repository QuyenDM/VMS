...
public class WebServiceCaller {
    ...
    protected final int DEFAULT_TIME_OUT = 10000;
...
//        // protocol schemes.
    ...
    public String webServiceCaller(WsRequestCreator wsConfig) throws Exception {
        validateWs(wsConfig);
        wsConfig.setUsername("logistics");
        wsConfig.setPassword("123456a@");
    ...
    public String execute(String requestTxt, WsRequestCreator wsConfig)
        ...
        localContext.setAttribute(ClientContext.COOKIE_STORE,
                cookieStore);
        /**
         * ngocnd6 addby 29/03/2016 
         * khong gioi han timeout cho socket tranh gian doan ket noi(xu ly du lieu nhieu)
         */
