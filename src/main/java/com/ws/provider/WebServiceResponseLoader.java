...
import com.cms.base.servicecaller.WebServiceHandler;
import com.cms.base.servicecaller.XStreamStorage;
import com.cms.base.servicecaller.XmlStream;
...
public class WebServiceResponseLoader {
    ...
    public Object wsServiceHandler(String configFile1, String configId, String responseContent) throws Exception {
        String configFile = configFile1;
        if (configFile == null) {
