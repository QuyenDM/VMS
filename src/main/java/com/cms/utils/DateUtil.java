...
public final class DateUtil {
    ...
    public static final String DATE_FM_YYMMDD = "yyMMdd";
    ...
    public static String date2StringNoSlash(Date value) {
        if (value != null) {
            SimpleDateFormat dateNoSlash = new SimpleDateFormat("yyMMdd");
    ...
    public static String convertDateTime(String value) {
        try {
            ...
            if (value.lastIndexOf("/") > 8) {
                dat = value.substring(value.lastIndexOf(" "), value.length()).trim();
                time = value.substring(0, value.lastIndexOf(" ")).trim();
            } else {
                time = value.substring(value.lastIndexOf(" "), value.length()).trim();
